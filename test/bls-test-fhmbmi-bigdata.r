...
plink.command = "/home/bioinfo/software/plink/plink"
...
ret1 <- bls.plink( file.phe.long, file.plink.bed, file.plink.bim, file.plink.fam, Y.name="E1_BMI", covar.names=c("SEX"), fgwas.filter = T,  refit = T , options=list(nParallel.cpu=15, fgwas.cutoff=0.05), force.split=TRUE, plink.command=plink.command);
